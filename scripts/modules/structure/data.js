...
export const explodeCraftData = {
  traditional: {
    ...
    explodedPieces: [
      { id: "left-side", label: "左侧板", src: "./assets/images/explode-traditional-left-side.png", left: "2%", top: "9%", width: "11%", enterX: "240px", enterY: "60px", rotate: "-7deg", z: 2 },
      { id: "mianban", label: "面板", src: "./assets/images/explode-traditional-mianban.png", left: "22%", top: "11%", width: "26%", enterX: "0px", enterY: "170px", rotate: "0deg", z: 5 },
      { id: "right-side", label: "右侧板", src: "./assets/images/explode-traditional-right-side.png", left: "54%", top: "9%", width: "9%", enterX: "-220px", enterY: "60px", rotate: "7deg", z: 2 },
      { id: "diban", label: "底板", src: "./assets/images/explode-traditional-diban.png", left: "69%", top: "8%", width: "28%", enterX: "-320px", enterY: "-80px", rotate: "4deg", z: 1 },
      { id: "left-panel", label: "左侧面板", src: "./assets/images/explode-traditional-left-panel.png", left: "24%", top: "3%", width: "20%", enterX: "70px", enterY: "180px", rotate: "-8deg", z: 6 },
      { id: "qianyueshan", label: "前岳山", src: "./assets/images/explode-traditional-qianyueshan.png", left: "25%", top: "18%", width: "16%", enterX: "120px", enterY: "220px", rotate: "-10deg", z: 7 },
      { id: "right-panel", label: "右侧面板", src: "./assets/images/explode-traditional-right-panel.png", left: "24%", top: "53%", width: "18%", enterX: "150px", enterY: "-180px", rotate: "8deg", z: 4 },
      { id: "yanzhu", label: "筝码", src: "./assets/images/explode-traditional-yanzhu.png", left: "31%", top: "29%", width: "18%", enterX: "0px", enterY: "120px", rotate: "-5deg", z: 8 },
      { id: "houyueshan", label: "后岳山", src: "./assets/images/explode-traditional-houyueshan.png", left: "22%", top: "83%", width: "20%", enterX: "0px", enterY: "-220px", rotate: "0deg", z: 7 },
      { id: "qinwei", label: "筝尾", src: "./assets/images/explode-traditional-qinwei.png", left: "21%", top: "91%", width: "22%", enterX: "0px", enterY: "-260px", rotate: "0deg", z: 9 },
      { id: "qintou", label: "筝头", src: "./assets/images/explode-traditional-qintou.png", left: "24%", top: "1%", width: "20%", enterX: "0px", enterY: "220px", rotate: "0deg", z: 9 },
    ],
  },
  "semi-hollow": {
    title: "半挖筝工艺",
